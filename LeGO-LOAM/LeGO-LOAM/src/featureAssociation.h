...
class FeatureAssociation : public rclcpp::Node {
 ...
 public:
  FeatureAssociation(const std::string &name, Channel<ProjectionOut_v2>& input_channel,
 ...
 private:
  ...
  Channel<ProjectionOut_v2>& _input_channel;
  Channel<AssociationOut_v2>& _output_channel;
  ...
  nav_msgs::msg::Odometry kf_odometryInfo;//
