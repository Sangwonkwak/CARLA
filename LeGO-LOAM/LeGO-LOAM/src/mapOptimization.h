...
class MapOptimization : public rclcpp::Node {
 ...
 public:
  MapOptimization(const std::string &name, Channel<AssociationOut_v2> &input_channel);
 ...
 private:
  ...
  Channel<AssociationOut_v2>& _input_channel;
  ...
  nav_msgs::msg::Odometry carla_odometryInfo;//
