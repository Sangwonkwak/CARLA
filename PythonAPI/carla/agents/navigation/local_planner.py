...
class LocalPlanner(object):
    ...
    def __init__(self, vehicle, opt_dict={}, map_inst=None, estimated_transform=None):
        """
    ...
    def _init_controller(self):
        ...
        self._vehicle_controller = VehiclePIDController(self._vehicle,
                                                        estimated_transform = self._estimated_transform,
    ...
    def _compute_next_waypoints(self, k=1):
        ...
        for _ in range(k):
            ...
            next_waypoints = list(last_waypoint.next(self._sampling_radius)) # 도로 종류에 따라 여러개가 생성될 수도 있음
    ...
    def my_run_step(self, debug=False):
        """
        ...
        veh_location = self._estimated_transform
